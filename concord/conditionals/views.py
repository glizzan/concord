...
from concord.conditionals.client import (PermissionConditionalClient, ApprovalConditionClient,
    VoteConditionClient)


def condition_landing_view(request, action_pk):
    pcc = PermissionConditionalClient(actor=request.user.username)
